...
class Indexer(MultiPlatformOp):
    ...
    def _get_topk_ragged(
        ...
        if use_bf16_index_cache:
            ...
            # matching the ragged [sum_k, 1, head_dim] layout expected by mqa_logits.
            kv_bf16 = torch.cat(
                [
                    forward_batch.token_to_kv_pool.get_index_k_continuous(
                        layer_id,
